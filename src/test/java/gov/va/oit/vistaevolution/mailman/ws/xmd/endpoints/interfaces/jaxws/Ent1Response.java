...
@XmlRootElement(name = "XMDEnt1Response", namespace = "http://vistaevolution.va.gov")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XMDEnt1Response", namespace = "http://vistaevolution.va.gov")
public class Ent1Response {
