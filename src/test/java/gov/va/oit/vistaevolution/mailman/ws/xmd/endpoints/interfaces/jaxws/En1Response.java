...
@XmlRootElement(name = "XMDEN1Response", namespace = "http://vistaevolution.va.gov")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "XMDEN1Response", namespace = "http://vistaevolution.va.gov")
public class En1Response {
