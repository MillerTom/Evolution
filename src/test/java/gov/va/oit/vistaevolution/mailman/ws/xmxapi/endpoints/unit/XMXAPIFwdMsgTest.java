...
import gov.va.oit.vistaevolution.mailman.ws.xmxapi.endpoints.XMXAPIFwdMsgEndpointImpl;
 ...
 * 
 */
public class XMXAPIFwdMsgTest extends VistaLinkContextTestParent {
	 ...
	 */
	@Test
	public void testfilterMsg() throws VistaWebServiceFault {

		String testResponse = "0^1 message forwarded.";

		// Set up the request object
		XMXAPIFwdMsgRequest request = new XMXAPIFwdMsgRequest();
		...
		XMXAPIFwdMsgEndpointImpl service = new XMXAPIFwdMsgEndpointImpl(
				getVistaLinkContext(), new XMXAPIResponseFactory());

		// Execute request against mocked object backend.
		XMXAPIFwdMsgResponse response = service.fwdMsg(request);
