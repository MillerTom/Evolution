...
public class XUSRB1EncrypIT extends VistaLinkContextITParent {

	private static final Logger LOG = Logger
			.getLogger(XUSRB1EncrypIT.class);
	 ...
	 * 
	 * Note this shows calls with same string gets encrypted differently
	 * 
	 ...
	 */
	@Test
	public void testEncryp005() throws VistaWebServiceFault {
		request.setSt1("");
        LOG.debug("Request Data: " + request.getSt1());
