...
public class XMVVITAEOtherResponse extends AbstractVistaResponse {
	...
	protected List<String> outputDataList;

	/**
	 * No Arguments Constructor.
	 */
	public XMVVITAEOtherResponse() {
		super();
	}
	 ...
	 * @param errors
	 */
	public XMVVITAEOtherResponse(List<String> outputDataList,
			List<String> errors) {
		super(errors);
