 ...
 */
@Component
@WebService(serviceName = "XMXUTILNonewService", portName = "XMXUTILNonewServicePort", endpointInterface = "gov.va.oit.vistaevolution.mailman.ws.xmxutil.endpoints.interfaces.XMXUTILNonewEndpoint")
public class XMXUTILNonewEndpointImpl extends SpringBeanAutowiringSupport
		implements XMXUTILNonewEndpoint {

	private static final Logger LOGGER = Logger
			.getLogger(XMXUTILNonewEndpointImpl.class);
	 ...
	 */
	public XMXUTILNonewEndpointImpl() {
		super();
	}
	 ...
	 */
	public XMXUTILNonewEndpointImpl(IVistaLinkContext vistaLinkContext,
	...
	@Override
	public XMXUTILNonewResponse nonew(XMXUTILNonewRequest request)
		...
		if (this.errCount > 0) {
			return new XMXUTILNonewResponse(null, errMsgs);
		} else {
			return xmxutilResponseFactory
					.createNonewResponseFromString(getVistaLinkContext()
							.makeRPCCall(
									new RPCIdentifier(VistaConstants.CONTEXT,
											XMXUTILConstants.NONEW_RPC), params));
		}
	}

	private LinkedList<Object> getParameters(XMXUTILNonewRequest request) {

		LinkedList<Object> parameters = new LinkedList<Object>();

		String msg = VistaConstants.ERR_MSG_INPUT_MISS.replace(
				VistaConstants.SRVNM, XMXUTILConstants.NONEW);
