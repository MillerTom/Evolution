 ...
 * 
 */
@XmlRootElement(name = "XMXSECPriorityRequest")
@XmlAccessorType(XmlAccessType.NONE)
public class XMXSECPriorityRequest extends AbstractVistaRequest {
	 ...
	 * @param xmz
	 */
	public XMXSECPriorityRequest(String xmz) {
		super();
		this.xmz = xmz;
	}
