 ...
 * 
 */
@XmlRootElement(name = "XMXSEC2OpteditResponse")
@XmlAccessorType(XmlAccessType.NONE)
public class XMXSEC2OpteditResponse extends AbstractXMXSEC2Response {
	 ...
	 * @param msgRoot
	 */
	public XMXSEC2OpteditResponse(List<String> optionsList, List<String> msgRoot) {
		super(msgRoot);
