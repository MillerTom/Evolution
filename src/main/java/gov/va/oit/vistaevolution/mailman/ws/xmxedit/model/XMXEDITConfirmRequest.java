 ...
 *
 * xmz:     (Required, Sequence = 1) Message Internal Entry Number (IEN)
...
public class XMXEDITConfirmRequest extends AbstractVistaRequest {
    ...
    /**
     * Default Bean Request
     */
    public XMXEDITConfirmRequest() {
        super();
    }
