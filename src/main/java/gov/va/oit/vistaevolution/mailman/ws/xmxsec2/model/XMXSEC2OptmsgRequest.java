 ...
 * 
 */
@XmlRootElement(name = "XMXSEC2OptmsgRequest")
@XmlAccessorType(XmlAccessType.NONE)
public class XMXSEC2OptmsgRequest extends AbstractVistaRequest {
	 ...
	 * XMK :
	 * 
	 * Basket IEN where the message is located. 0 – If not in basket
	 * 
	 * 
	 * XMZ :
	 * 
	 ...
	 * @param xmz
	 */
	public XMXSEC2OptmsgRequest(String xmduz, String xmk, String xmz) {
		super();
		this.xmduz = xmduz;
		this.xmk = xmk;
		this.xmz = xmz;
