 ...
 * 
 * xmz:         (Required, Sequence = 1)  Message Internal Entry Number
 *              (IEN) in the MESSAGE file (#3.9).
 * 
 * xminstr:     (Required, Sequence = 2) Array of special instructions:
 * 
...
public class XMXEDITInfoRequest extends AbstractVistaRequest {
    ...
    /**
     * @param xminstr the xminstr to set
     */
