...
public class DICListResponse extends AbstractVistaResponse {

	/**
	 * 
	 * outputDataList :
	 * 
	 * The array that should receive the output list.
	 * 
	 */
	 ...
	 */
	public DICListResponse(List<String> outputDataList) {
		super();
